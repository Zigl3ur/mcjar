	...
	test := []testData[expectedData, string]{
		{
			expectedData{"forge",
				"mod",
				[]string{"1.20.1", "1.11.2", "1.16.1"}}, "[[\"project_type:mod\"],[\"versions:1.20.1\",\"versions:1.11.2\",\"versions:1.16.1\"],[\"categories:forge\"]]", false,
		}, {
			expectedData{"",
				"plugin",
				[]string{"1.18.2", "1.8.9", "1.17.1", "1.14.2", "1.7.1"}}, "[[\"project_type:plugin\"],[\"versions:1.18.2\",\"versions:1.8.9\",\"versions:1.17.1\",\"versions:1.14.2\",\"versions:1.7.1\"]]", false,
		}, {
			expectedData{"fabric",
				"mod",
				[]string{"1.21.1", "1.9.7"}}, "[[\"project_type:mod\"],[\"versions:1.21.1\",\"versions:1.9.7\"],[\"categories:fabric\"]]", false,
		}, {
			expectedData{"neoforge",
				"mod",
				[]string{"1.9", "1.8.2", "1.15"}}, "[[\"project_type:mod\"],[\"versions:1.9\",\"versions:1.8.2\",\"versions:1.15\"],[\"categories:neoforge\"]]", false,
		}, {
			expectedData{"forge",
				"modpack",
				[]string{"1.16.3", "1.13.2", "1.8"}}, "[[\"project_type:modpack\"],[\"versions:1.16.3\",\"versions:1.13.2\",\"versions:1.8\"],[\"categories:forge\"]]", false,
		},
	}
